...
file_handler = logging.FileHandler("/tmp/monkeytype_log.log")
...
def process_file(file_path):
    ...
    monkeytype_script_cmd = "monkeytype run script.py"
    monkeytype_stub_cmd = "monkeytype stub trace.main > trace/main.pyi"

    subprocess.run(
        monkeytype_script_cmd,
        monkeytype_stub_cmd,
        shell=True,
        cwd=dir_path,
        check=True,
